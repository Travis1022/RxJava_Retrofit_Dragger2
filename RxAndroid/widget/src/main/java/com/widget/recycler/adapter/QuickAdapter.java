...
import com.sunnybear.library.util.dynamic.AntiShakeClick;
...
public abstract class QuickAdapter<Item extends Serializable, VH extends QuickViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    //点击防抖
    private AntiShakeClick mAntiShakeClick;
    ...
    public QuickAdapter(Context context, List<Item> items) {
        ...
        mAntiShakeClick = new AntiShakeClick();
    }
        ...
        if (mOnItemClickListener != null)
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mAntiShakeClick.click(new Runnable() {
                        @Override
                        public void run() {
